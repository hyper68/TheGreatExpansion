package net.mcreator.thegreatexpansion.fluid.types;
...
public class CrudeOilFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_great_expansion:block/crudeoilfluid");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_great_expansion:block/crudeoilfluid");
		...
		}, TheGreatExpansionModFluidTypes.CRUDE_OIL_TYPE.get());
	}
}