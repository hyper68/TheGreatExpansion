...
public class TheGreatExpansionModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> THE_GREAT_EXPANSION = REGISTRY.register("the_great_expansion",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.the_great_expansion.the_great_expansion")).icon(() -> new ItemStack(Blocks.DIAMOND_ORE)).displayItems((parameters, tabData) -> {
				...
				tabData.accept(TheGreatExpansionModBlocks.SKY_STONE.get().asItem());
				tabData.accept(TheGreatExpansionModItems.SKY_BERRIES.get());
				tabData.accept(TheGreatExpansionModItems.THE_SKYLANDS.get());
				tabData.accept(TheGreatExpansionModItems.SKYSHARD.get());
				tabData.accept(TheGreatExpansionModItems.SKY_CATALYST.get());
				tabData.accept(TheGreatExpansionModItems.SKYLARIAM_GEM.get());
	...
	public static void buildTabContentsVanilla(BuildCreativeModeTabContentsEvent tabData) {
		if (tabData.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
			...
			tabData.accept(TheGreatExpansionModBlocks.PALO_PRESSURE_PLATE.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.PALO_BUTTON.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_LOG.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_WOOD.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.STRIPPED_SKYWOOD_LOG.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.STRIPPED_SKYWOOD_WOOD.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_PLANKS.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_STAIRS.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_SLAB.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_FENCE.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_FENCE_GATE.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_DOOR.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_TRAPDOOR.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_PRESSURE_PLATE.get().asItem());
			tabData.accept(TheGreatExpansionModBlocks.SKYWOOD_BUTTON.get().asItem());
