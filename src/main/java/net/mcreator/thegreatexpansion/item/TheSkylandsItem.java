...
import net.mcreator.thegreatexpansion.block.TheSkylandsPortalBlock;

public class TheSkylandsItem extends Item {
	public TheSkylandsItem() {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				TheSkylandsPortalBlock.portalSpawn(world, pos);
