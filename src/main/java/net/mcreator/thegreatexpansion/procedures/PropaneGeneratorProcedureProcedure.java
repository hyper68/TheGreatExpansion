...
public class PropaneGeneratorProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((itemFromBlockInventory(world, BlockPos.containing(x, y, z), 0).copy()).getItem() == TheGreatExpansionModItems.FILLED_PROPANE_TANK.get()
				&& getEnergyStored(world, BlockPos.containing(x, y, z), null) + 500 <= getMaxEnergyStored(world, BlockPos.containing(x, y, z), null)) {
		...
		if (canReceiveEnergy(world, BlockPos.containing(x, -1, z), null)) {
			if (world instanceof ILevelExtension _ext) {
				IEnergyStorage _entityStorage = _ext.getCapability(Capabilities.EnergyStorage.BLOCK, BlockPos.containing(x, y, z), null);
				if (_entityStorage != null)
					_entityStorage.extractEnergy(500, false);
			}
			if (world instanceof ILevelExtension _ext) {
