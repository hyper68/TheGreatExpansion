...
public class WaterPumpBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(2, ItemStack.EMPTY);

	public WaterPumpBlockEntity(BlockPos position, BlockState state) {
		super(TheGreatExpansionModBlockEntities.WATER_PUMP.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("water_pump");
	}

	@Override
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new WaterPumpGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Water Pump");
	}
	...
	private final FluidTank fluidTank0 = new FluidTank(12000, fs -> {
