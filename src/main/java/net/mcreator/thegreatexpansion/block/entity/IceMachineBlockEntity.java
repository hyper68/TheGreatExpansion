...
public class IceMachineBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(9, ItemStack.EMPTY);

	public IceMachineBlockEntity(BlockPos position, BlockState state) {
		super(TheGreatExpansionModBlockEntities.ICE_MACHINE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("ice_machine");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Ice Machine");
	}
