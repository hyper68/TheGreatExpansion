...
import net.mcreator.thegreatexpansion.procedures.CrusherProcedureProcedure;
...
public record CrusherGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<CrusherGUISlotMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(TheGreatExpansionMod.MODID, "crusher_gui_slots"));
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		if (slot == 0 && changeType == 0) {
			...
			CrusherProcedureProcedure.execute(world, x, y, z);
		}
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TheGreatExpansionMod.addNetworkMessage(CrusherGUISlotMessage.TYPE, CrusherGUISlotMessage.STREAM_CODEC, CrusherGUISlotMessage::handleData);
	}
}