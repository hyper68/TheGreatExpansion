...
public class reinforcedchestAnimation {
	public static final AnimationDefinition ChestOpen = AnimationDefinition.Builder.withLength(0.5F)
			.addAnimation("bone",
	...
	public static final AnimationDefinition ChestClose = AnimationDefinition.Builder.withLength(0.5F)
			.addAnimation("bone",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
